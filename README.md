...
```bash
cat ~cs1531/bin/iter1.1.test.js
```
...
To view the dryrun tests, you can run the following command on CSE machines:
```bash
cat ~cs1531/bin/iter1.2.test.js
```
...
| 1.2         | 6pm Friday 20th June (**week 3**)    | In YOUR **week 4** laboratory | 15% of project mark      |
...
| 1         | **Week 4**    | Iteration 1 Part 2 completed                                                                                  |
...
<table>
  ...
  <tr>
    <td>1</td>
    <td>6pm Friday 20th June</td>
    <td>6pm Monday 23th June</td>
  </tr>
  <tr>
    <td>2</td>
